...
!(function() {
  ...
  function a() {
    function a() {
      function a(a, d) {
        function e(a) {
          var d = 1 === (f = 1 - f) ? "width" : "height";
          return c[d] + Math.floor(Number(a) * b[d]);
        }
        var f = 0;
        j[d].coords = a
          .split(",")
      ...
      var b = {
          width: l.width / l.naturalWidth,
          height: l.height / l.naturalHeight
        },
        c = {
          width: parseInt(
            window.getComputedStyle(l, null).getPropertyValue("padding-left"),
            10
          ),
          height: parseInt(
    ...
    function h() {
      (j = i.getElementsByTagName("area")),
        (k = Array.prototype.map.call(j, b)),
        (l = g("#" + i.name) || g(i.name)),
        (i._resize = a);
    }
    var i = this,
